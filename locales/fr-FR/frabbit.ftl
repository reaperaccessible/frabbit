...
wizard-packages-osara-keymap-replace-label = Remplacer vos raccourcis clavier actuels par les raccourcis OSARA
wizard-packages-osara-keymap-unavailable-note = Sélectionnez OSARA pour configurer le comportement des raccourcis clavier.
wizard-packages-osara-keymap-preserve-note = Pour les utilisateurs avancés : vos raccourcis clavier actuels seront préservés. FRABBIT ne touchera pas reaper-kb.ini, vous devrez gérer manuellement la mise à jour avec les derniers ajouts de raccourcis OSARA.
wizard-packages-osara-keymap-replace-note = Recommandé pour les utilisateurs débutants à intermédiaires : FRABBIT sauvegardera une copie de votre fichier reaper-kb.ini actuel, puis le remplacera par la dernière version des raccourcis OSARA.
...
wizard-review-osara-keymap-preserve = Préserver vos raccourcis clavier actuels.
